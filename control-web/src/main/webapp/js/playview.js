...
PlayView.prototype.initialize = function () {
...
PlayView.prototype.createChart = function () {
...
PlayView.prototype.initializeChart = function () {
    var view = this;
...
PlayView.prototype._x = function (n) {
    return d3.scale.linear()
            .domain([0, 1])
            .range([0, this.barWidth()])(n);
}

PlayView.prototype.barWidth = function () {
    var dataLength = Math.max(this.data.length, 1);
    return this.elementWidth / this.MAX_DATA_SIZE;
}

PlayView.prototype.onScore = function (name,score) {
...
PlayView.prototype.close = function () {
