(function() {
	...
	breakout.logo = function() {
		Crafty.sprite(1, '../resources/images/logo.png', {
			logo: [0, 0, 131, 175]
		});
	...
	breakout._createBackgroundViaImage = function() {
		...
		Crafty.sprite(1, '../resources/images/bg_prerendered.png', {
			bg: [0, 0, width, height]
		});
	...
	breakout._createBackgroundViaTiles = function() {
		Crafty.sprite(16, '../resources/images/tiles.png', {
			r: [11, 3],
			l: [11, 4],
			v: [11, 5],
			h: [11, 6],
